...
fun LineChart(
    ...
    Canvas(
        ...
        val remainHeightForLabels = labelViewPortHeightPx - heightRequiredForLabels
        val spaceBetweenLabels = remainHeightForLabels / labelCountExcludingLastLabel
